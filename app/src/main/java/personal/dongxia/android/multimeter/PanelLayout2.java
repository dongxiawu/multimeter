...
public class PanelLayout2 extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
     ...
     * @param context
     */
    public PanelLayout2(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public PanelLayout2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Set a callback to override {@link PanelLayout2#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link PanelLayout2#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link PanelLayout2#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull PanelLayout2 parent, @Nullable View child);
    }
}
